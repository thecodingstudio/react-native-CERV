            ...
            <ScrollView>
                ...
                <View style={styles.screen}>
                    <View style={styles.food_category}>
                        ...
                        <Text style={{marginTop:10, color:Colors.BLACK , fontWeight:'bold', fontSize:18}}>{selectedCaterer.food_category}</Text>
                    </View>
                    <Text style={styles.label}>Bio</Text>
                    <Text style={{marginTop:10, color:Colors.BLACK , fontWeight:'bold', fontSize:18}}>{selectedCaterer.bio}</Text>
                </View>
