        ...
        <View style={styles.container} >
            ...
            <Animatable.View style={styles.footer} animation="fadeInUpBig">
                ...
                <View style={styles.action} >
                    ...
                    <SelectDropdown 
                        data={ dummy_codes } 
                        onSelect={(selectedItem, index) => setSelectedCode(selectedItem)} 
                    ...
                    <TextInput 
                        ...
                        onChangeText={(text) => numberHandler(text)}
                        value={phoneNumber}
                        maxLength={10}
                        />
                </View>
                ...
                <TouchableOpacity onPress={() => {
                    ...
                    props.navigation.navigate('VerifyScreen',{phoneNumber: phoneNumber , code: parseInt(selectedCode,10)});
                }} >
